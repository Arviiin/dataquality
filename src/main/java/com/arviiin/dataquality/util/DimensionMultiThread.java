 ...
 * 有返回值的多线程
 */
public class DimensionMultiThread implements Callable<String> {

	private static Logger logger = LoggerFactory.getLogger(DimensionMultiThread.class);
	...
	public DimensionMultiThread(int i, CountDownLatch endSignal, DimensionBean dimensionBean, DimensionResultBean dimensionResultBean) {
		this.dimensionService = ApplicationContextProvider.getBean(DimensionService.class);
		this.totalRecordAmount = i;
